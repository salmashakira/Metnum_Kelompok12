...
def main():
    ...
    metode = int(input("Masukkan metode yang dipilih: "))
    ...
    turunan_ke = int(input("Masukkan turunan yang ingin dihitung (1 atau 2): "))
    ...
    if turunan is not None:
        if metode == 1:
            print(f"Hasil nilai turunan ke-{turunan_ke} menggunakan metode Selisih Maju: {turunan}")
        elif metode == 2:
            print(f"Hasil nilai turunan ke-{turunan_ke} menggunakan metode Selisih Mundur: {turunan}")
        elif metode == 3:
            print(f"Hasil nilai turunan ke-{turunan_ke} menggunakan metode Selisih Pusat: {turunan}")
        else:
            print("Pilihan metode salah.")
